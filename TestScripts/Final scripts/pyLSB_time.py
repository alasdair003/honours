...
# Benchmarking for 100
# Maybe leave pc on for a while for 1000
...
print(f"Average Encoding Time: {avg_encode:.6f} sec")
print(f"Average Decoding Time: {avg_decode:.6f} sec")
